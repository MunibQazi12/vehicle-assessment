...
export default function HiringEventJune12() {
	return (
		<>
			<main>
				...
				<section className="w-full max-w-[1400px] mx-auto relative aspect-[2048/762]">
					<Image
						src="https://cdn.dealertower.com/website-media/content/73d6c4fc-8ffb-471e-88c4-5e8eeddc1c63/HIRING-12TH-1.webp"
						alt="Upcoming Hiring Event - Thursday June 12 at Hampton Inn & Suites"
						fill
